!function($) {
        ...
        try {
            $(function() {
                try {
                    ...
                    r.each(function() {
                        try {
                            if ("yandex" === $(this).data("service") && (t = !0,
                            l = $('.macros-map[data-service="yandex"]')),
                                    ...
                                    return l.each(function() {
                                        try {
                                            ...
                                            return e = plp.lazy.add($(this), function(r) {
                                                try {
                                                    var l, a, t, i, n;
                                                    return l = e.children(".map"),
                                                    a = l.data("map"),
                                                    t = _.uniqueId("map"),
                                                    l.attr("id", t),
                                                    "roadmap" === a.type && (a.type = "yandex#map"),
                                                    i = new ymaps.Map(t,{
                                                        center: a.center,
                                                        type: a.type,
                                                        zoom: a.zoom,
                                    ...
                                    try {
                                        ...
                                        return e = plp.lazy.add($(this), function(r) {
                                            try {
                                                ...
                                                t = _.uniqueId("map"),
                                                l.attr("id", t),
                                                "yandex#map" === a.type && (a.type = "roadmap"),
    ...
    plp.l10n = function(e, r) {
        try {
            ...
            return l && l[plp.lang] ? l[plp.lang] : (console.error("No translation for ", e),
            e)
        } catch (a) {
    ...
    //                 return t = window.plp_page_id || window.plp.page_id,
    ...
    //                     try {
    //                         var a;
    //                         return "xs" === plp.screen ? (a = e,
    //                         r && (a += "\n" + r),
    //                         alert(a),
    //                         void (l && l())) : Modernizr.cssanimations ? swal({
    //                             title: e,
    //                             text: r || null,
    //                             type: "error"
    //                         }, l) : swal({
    ...
    //                                 g = u.closest('[data-modal="cart"]').length ? plp.cart.list : [],
    //                                 f = u.data("fields"),
    //                                 b = {
    //                                     hit: {
    //                                         page_id: t,
    ...
    //                                         if (r = $(this),
    //                                         t = b.fields[e],
    //                                         "radio-list" === t.type && r.find("input").prop("name", _.uniqueId("radio")),
    //                                         "textarea" === t.type && r.find("textarea").val(function(e, r) {
    //                                             try {
    //                                                 return $.trim(r)
    //                                             } catch (l) {
    ...
    //                                                         try {
    //                                                             var e, t;
    //                                                             for (t = r.find(":file").closest(".pseudo"),
    //                                                             t.clone().insertAfter(t),
    //                                                             e = $("<form>"),
    //                                                             i = 0,
    //                                                             attributes = t[0].attributes; i < attributes.length; i++)
    //                                                                 e.attr(attributes[i].name, attributes[i].value);
    //                                                             return e.append(t.children()),
    ...
    //                                                                 error: function(t) {
    //                                                                     try {
    //                                                                         return l(plp.l10n("Ошибка загрузки!"), 400 === t.status ? t.responseText : null),
    ...
    //                                     //     $.now() - n < o ? void l(r.error, r.interval) : (d = [],
    //                                     //     h.each(function(e) {
    //                                     //         try {
    //                                     //             var l;
    //                                     //             if ("checkbox-input" === b.fields[e].type ? b.fields[e].value = $(this).find("input").prop("checked") ? s : c : "radio-list" === b.fields[e].type ? b.fields[e].value = $(this).find("[type=radio]:checked").val() || "" : "select-menu" === b.fields[e].type ? b.fields[e].value = $(this).find("select").val() : "hidden" === b.fields[e].type ? (b.fields[e].name = b.fields[e].id,
    //                                     //             b.fields[e].value = $(this).find("input").val()) : "file" === b.fields[e].type ? b.fields[e].value = $(this).data("result") || "" : (l = $(this).find(".form-control").data("placeholder"),
    //                                     //             b.fields[e].value = l ? "" : $(this).find(".form-control").val()),
    //                                     //             b.fields[e].required && "" === b.fields[e].value && d.push(r.required.replace("%field%", b.fields[e].name)),
    //                                     //             "" === b.fields[e].value)
    //                                     //                 return;
    //                                     //             if ("email" !== b.fields[e].type || /.+@.+\..+/.test(b.fields[e].value) || d.push(r.email.replace("%field%", b.fields[e].name)),
    //                                     //             "phone" === b.fields[e].type && !/.*\d.*\d.*\d.*\d.*/.test(b.fields[e].value))
    //                                     //                 return d.push(r.phone.replace("%field%", b.fields[e].name))
    //                                     //         } catch (a) {
    //                                     //             error_handler(a, "libs_plp 18", arguments.callee)
    //                                     //         }
    //                                     //     }),
    //                                     //     "checkbox" === m.privacy && (t = u.closest(".body").find(".agreement-checkbox input").prop("checked"),
    //                                     //     f = m.privacy_checkbox.replace(/[<>]/g, ""),
    //                                     //     t === !1 && d.push(r.required.replace("%field%", f))),
    //                                     //     d.length > 0 ? (u.trigger("submit-error"),
    //                                     //     void l(r.validate, d.join("\n"))) : (y = {
    //                                     //         name: "",
    //                                     //         phone: "",
    //                                     //         email: "",
    //                                     //         count: "",
    ...
    //                                     //         try {
    //                                     //             var r;
    //                                     //             if ("" === y[e.type] && (y[r = e.type] || (y[r] = e.value)),
    //                                     //             !y.fields[e.name])
    //                                     //                 return y.fields[e.name] = e.value
    //                                     //         } catch (l) {
    ...
    //                                     //             p.prop("disabled", !1),
    //                                     //             l(r.error, 400 === e.status ? e.responseText : null),
    //                                     //             o = $.now()
    //                                     //         } catch (i) {
    ...
    //                                         //     url:"send_form.php",
    //                                         //     data:form_data,
    //                                         //     success:function(){$("#form input").val(""),$("#form2 input").val(""),alert("Спасибо! Ваши контакты отправлены. Наш менеджер свяжется с вами в ближайшее время")},
    ...
    $(function() {
        try {
            ...
            a.each(function() {
                try {
                    var e = $(this)
                      , r = e.attr("data-modal")
                      , a = e.closest(".node");
                    a.hasClass("widget-field") && (a = a.closest("[data-form]")),
                    a.length || (a = e.closest(".modal")),
                    ["cart", "agreement", "cookie"].indexOf(r) !== -1 && (a = $("div.area").first());
            ...
            return t && plp.modal.openbyid(t[1]),
            ...
            $(document).on("click", function(l) {
                try {
                    if (!e.length)
                        return;
                    if ($(l.target).closest(a).length)
                        return;
                    if ($(l.target).closest('a[href^="#modal-"]').length)
                        return;
                    var t = _.last(e);
                    if (l.target === t[0])
                        return plp.modal.close();
                    if ($(l.target).closest(".modal-header > .close").length)
                        return plp.modal.close();
                    var i = $(l.target).closest(".modal");
                    if (i.length && i[0] !== t[0])
                        return plp.modal.close();
                    if (!$(l.target).closest(r).length)
                        return plp.modal.close()
                } catch (n) {
    ...
    $(document).ready(function() {
                ...
                _.remove(m, function(l) {
                    try {
                        ...
                        if (a) {
                            ...
                            "page" == l.type && (t = "section-helper"),
                            e(l.type + "_events", t, l.name)
                        }
                        return a
                    } catch (i) {
        ...
        function d(e) {
            try {
                ...
                if (!$(".modal:visible").length) {
                    ...
                    if (d.inview && l(d.inview.modal),
                    d.longview && t(d.longview.modal, 6e4),
                    d.doubleback && (d.doubleback.status ? l(d.doubleback.modal) : u.update.doubleback || (u.update.doubleback = d.doubleback)),
                    ...
                    d.pagelongview && a(d.pagelongview, 6e4),
                    d.pagelongview2min && a(d.pagelongview2min, 12e4),
                    d.pagelongview4min && a(d.pagelongview4min, 24e4),
                    d.scrollend) {
                        var v = $(".section-helper").index(".section") - 1
                          , g = !1;
                        if (e)
                            g = v === u.section.index(".section");
                        else {
                    ...
                    d.hourlyvisit && c(1800, 2, d.hourlyvisit.modal),
                    d.weeklyvisit && c(604800, 3, d.weeklyvisit.modal),
        ...
        function p() {
            try {
                for (var e = !1, r = 0; r < f.elements.length; r++) {
                    ...
                    i >= a && i <= a + t + window.innerHeight / 4 && (l !== f.$previousReaction && (f.$previousReaction && f.$previousReaction.$buttons.find('button[need_hover="true"]').removeClass("hover-on-scroll"),
                    l.$buttons.find('button[need_hover="true"]').addClass("hover-on-scroll"),
                    f.$previousReaction = l),
                    e = !0)
                }
                !e && f.$previousReaction && (f.$previousReaction.$buttons.find('button[need_hover="true"]').removeClass("hover-on-scroll"),
        ...
        try {
            ...
            _.each($(".section"), function(e, r) {
                try {
                    var l = $(e);
                    if (l.hasClass("section-helper"))
                        var a = l.find(".eventmodals .modal")
                          , t = "page";
                    else
                        var a = l.find("> .macros-modal > .modal")
                          , t = "section";
                    ...
                    _.each(a, function(e, r) {
                        try {
                            ...
                            if ("page" == t) {
                                ...
                                "pagelongview" != i.name && "pagelongview2min" != i.name && "pagelongview4min" != i.name || (o = _.filter(s, function(e) {
                                    try {
                ...
                try {
                    ...
                    $('[data-action="formscroll"]').each(function() {
                        try {
                            ...
                            a = r.prevAll(".section"),
                            l = r.nextAll(".section"),
                            e = t.hasClass("btn") ? t : t.find(".btn"),
                            e.on("click", function() {
                                try {
                                    var e, t, i;
                                    if (t = l.find(".form:visible, [data-form]:visible").first(),
                                    1 === t.length)
                                    ...
                                    if (i = a.find(".form:visible, [data-form]:visible").last(),
                                    1 === i.length)
                                        return $("html, body").animate({
                    ...
                    $(document).on("click", 'a[href^="#"]', function(e) {
                        try {
                            ...
                            a.length) {
                                ...
                                r.length && (n -= r.height()),
                                $("html").hasClass("pp"))
                                    i = a.closest(".pp-section").index(".pp-section"),
                                    i = a.closest(".pp-section").index(".pp-section"),
                    ...
                    a = location.href.match(/scrollblock=(\d+)/)) {
                        if (o = location.href.match(/scrolloffset=(-?\d+)/),
                        n = o.length ? 1 * o[1] : 0,
                        i = 1 * a[1],
                        e = $(".node.section").eq(i),
                        e.length)
                            return c = e.offset().top + n,
    ...
    $(function() {
        try {
            ...
            var e = function(e) {
              ...
              , t = a.find(".cont").first()
              , i = t.next();
            t.find('[data-role="itemphoto"]').attr("data-lazy-bgimage", l),
                ...
                try {
                    ...
                    if (_.each(plp.cart.list, function(e, l) {
                        try {
                            ...
                            r.value === i.value && a.value === n.value && (s.value += 1 * t.value,
                            o.children().eq(l).trigger("setamount", [s.value]),
                            c = !0)
                        } catch (d) {
                    ...
                    plp.cart.list.push(e),
                    store.set("cart", plp.cart.list),
                    plp.cart.update();
                    var d = $(n.data("template"));
                    o.append(d),
                    d.find('[data-role="setamount"]').val(t.value),
                    d.find('[data-role="itemprice"]').html(a.value),
                    d.find('[data-role="itemname"]').html(r.value),
                    d.find('[data-role="itemphoto"]').css("backgroundImage", 'url("' + (i.value || l) + '")').removeAttr("data-lazy-bgimage").removeAttr("data-lazy-bgimage_size"),
                    s = s.add(d),
                    d.on("setamount", function(e, r) {
                        try {
                            ...
                            t.value ? plp.cart.update() : d.trigger("removefromcart")
                        } catch (l) {
                    ...
                    d.on("removefromcart", function(r) {
                        try {
                            plp.cart.list.splice(plp.cart.list.indexOf(e), 1),
                            store.set("cart", plp.cart.list),
            ...
            plp.cart.update = function() {
                try {
                    ...
                    t.show(),
                    i.hide(),
                    $('[data-role="carttotal"] span').html(l.replace("%s%", n))
                } catch (o) {
    ...
    $(function() {
        ...
        function l(r, l) {
            try {
                plp.isRetina() && l.retina && (l.width2 *= 2,
                l.height2 *= 2);
                var a = Math.min(l.width1, 2e3)
                  , t = Math.min(l.height1, 2e3);
                l.width2 > a && (l.height2 = a / l.width2 * l.height2,
                l.width2 = a),
                l.height2 > t && (l.width2 = t / l.height2 * l.width2,
                l.height2 = t);
                var i = e({
                    h: l.height2 || 1,
                    w: l.width2 || 1
                ...
                try {
                    ...
                    if (r(a) && "true" !== e.attr("data-lazy-image_noscale")) {
                        ...
                        if ("css-width" === n)
                            ...
                            i.height1 > c ? (i.height2 = c,
                            i.width2 = c / i.height1 * i.width1) : e.css("max-height", i.height2)
                    ...
                    e.addClass("lazy-loading"),
                    $("<img>").attr("src", a).on("load", function() {
                        try {
                            e.attr("src", a),
                            e.removeClass("lazy-loading"),
                            e.trigger("lazyload")
            ...
            plp.lazy.add($("[data-lazy-bgimage]"), function(e) {
                try {
                    ...
                    if (r(a) && "true" !== e.attr("data-lazy-bgimage_noscale")) {
                        ...
                        "cover" === c ? (i.width1 > n && (i.width2 = n,
                        i.height2 = n / i.width1 * i.height1),
                        i.height2 < o && (i.height2 = o,
                        i.width2 = o / i.height1 * i.width1)) : "contain" === c && (i.width2 > n && (i.width2 = n,
                        i.height2 = n / i.width1 * i.height1),
                        i.height2 > o && (i.height2 = o,
                        i.width2 = o / i.height1 * i.width1));
                        var a = l(a, i)
                    }
                    e.data(),
                ...
                try {
                    return $(".node[data-bgvideo]").each(function() {
                        try {
                            ...
                            return e = $(this),
                            r = e.data("bgvideo"),
                            plp.lazy.add(e.removeAttr("data-bgvideo"), function(l) {
                                try {
                                    var a;
                                    if ("youtube" === r.bgVideo_Source)
                                        return a = $("<div></div>").prependTo(e.children(".wrapper1")),
                                        a.data("property", {
    ...
    //                                     if (fieldSlideIndex > activeSlideIndex)
    //                                         return
    //                                 }
    //                                 var field = {
    //                                     name: vals.text,
    ...
    //                                         try {
    //                                             $(this).prop("checked") && (field.value.push(vals.list[e].text),
    //                                             indexes.push(e))
    //                                         } catch (r) {
    //                                             error_handler(r, "libs_plp 6", arguments.callee)
    //                                         }
    ...
    //                                     index >= 0 ? field.value = vals.list[index].text : (field.value = "",
    ...
    //                                     template || (template = _.template(vals.template),
    //                                     $field.data("template", template)),
    //                                     $field.find("[plp-field-template]").html(template(scope))
    //                                 }
    ...
    //                     //     var r = $form.data("form")
    //                     //       , l = $form.closest("[data-item]").data("item") || [];
    //                     //     if ($form.data("isquiz")) {
    //                     //         var a = $form.find("[plp-form-container]").first().find("> .swiper-wrapper > .swiper-slide");
    //                     //         if (a.filter(".swiper-slide-next").length)
    ...
    //                     //                     try {
    //                     //                         "" === n[e.type] && (n[e.type] = e.value),
    //                     //                         n.fields[e.name] || (n.fields[e.name] = e.value)
    //                     //                     } catch (r) {
    //                     //                         error_handler(r, "libs_plp 15", arguments.callee)
    //                     //                     }
    //                     //                 }),
    ...
    //                     //                                 if (!n.items[r][e.type]) {
    //                     //                                     var l;
    //                     //                                     l = "amount" === e.type || "photo" === e.type ? e.value : _.escape(e.value),
    //                     //                                     n.items[r][e.type] = l
    //                     //                                 }
    //                     //                             } catch (a) {
    //                     //                                 error_handler(a, "libs_plp 18", arguments.callee)
    ...
    //                     //                         error_handler(e, "libs_plp 21", arguments.callee)
    //                     //                     }
    //                     //                 }) : "js" === r.after && (jscode = "(function (data) {with (data) {" + r.js + "}})(<%= data %>);",
    //                     //                 $.globalEval(_.template(jscode, {
    //                     //                     data: JSON.stringify(n)
    //                     //                 }))),
    //                     //                 $form.trigger("reset"),
    //                     //                 items.length && plp.cart.empty(),
    //                     //                 plp.modal.closeAll(),
    //                     //                 send_last = $.now()
    //                     //             } else
    //                     //                 $form.trigger("submit-error"),
        ...
        try {
            $(".node[bgparticles]").each(function() {
                try {
                    ...
                    a.canvas.el.style.borderRadius = l.css("border-radius"),
                    a.interactivity.events.onclick.handler = function(e) {
                        try {
                            var r = $(e.target);
            ...
            l.length && $(document).on("ready scroll", function(t) {
                try {
                    ...
                    if (e)
                        ...
                        var n = l.offset().top;
                        i > n && (r.css("height", l.height()).insertAfter(l),
                        l.css("opacity", a),
                        l.addClass("fixed"),
                        e = !0)
                    }
    ...
    $(function() {
        try {
            var e = !1
              ...
              , a = l.attr("data-opacity");
            if (l.length) {
                if (l.next().hasClass("section-helper"))
                    return l.css("opacity", a),
                    void l.addClass("fixed");
...
$("#form2, #form3").submit(function() {
    ...
    success: function() {     
       ...
       $('.modal-header .close', par).trigger( "click" );
        ...
        $('.message .success').toggle();
        $('.sweet-alert h2').text('Спасибо! Ваши контакты успешно отправлены.');
        // $('.sweet-alert h2').text('Сcылка для скачивания чек-листа:');
        // $('.sweet-alert p').html('<a href="#" class="download" >Скачать чек-лист</a>')
    },
    error:  function(xhr, str){
      // alert('Возникла ошибка: ' + xhr.responseCode);
      $('.message').toggle();

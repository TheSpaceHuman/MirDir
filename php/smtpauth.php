...
function MailSmtp($reciever, $subject, $content, $headers, $debug = 0) {
  ...
  $smtp_user = 'mir-dit@yandex.ru'; // Имя пользователя для авторизации на SMTP-сервере
  $smtp_password = 'qaz12345'; // Пароль для авторизации на SMTP-сервере
  $mail_from = 'Mir-Dit'; // Ящик, с которого отправляется письмо
